...
<section>
    ...
    <div class="mainpanel">
        <div class="contentpanel">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <form action="" method="post">
                        <input type="hidden" name="tipoForm" value="salvar-familia">
                        <div class="panel">
                            <div class="panel-heading">
                                <h4 class="panel-title">Familia</h4>
                            </div>
                            <div class="panel-body">
                                <div class="col-md-6 col-lg-11">
                                    <div class="form-group">
                                        <input type="text" name="nfamilia" placeholder="Nome da Familia"
                                               class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 col-lg-12">
                                    <div class="form-group">
                                        <textarea id="autosize" name="sfamilia" class="form-control" rows="7"
                                                  placeholder="Sobre a Familia" data-autosize-on="true"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12'">
                    <c:forEach var="familia" items="${listarFamilias}">
                    <div class="col-xs-12 col-md-4 col-lg-3 mt20">
                        <div class="profile-left-heading">
                            <ul class="panel-options">
                                ...
                                <li><a href="listafamilias?remover=remover&id=${familia.id}"><i class="glyphicon glyphicon-option-vertical"></i></a></li>
                            </ul>
                            <h2 class="profile-name">${familia.nome}</h2>
                            <h4 class="profile-designation">${familia.descricao}</h4>
                        </div>
                    </div>
                    </c:forEach>
                </div>
